...
class ASR(object):
    def __init__(self, corpus='', target='./', label=(), dump='IDump.txt', nState=3, nFeature=39, features=None,
    ...
    def feature(self):
        fout = open(self.X['wavlst_scp'], 'w')
        for line in self.X['features']:
            fout.write(line+'\n')
